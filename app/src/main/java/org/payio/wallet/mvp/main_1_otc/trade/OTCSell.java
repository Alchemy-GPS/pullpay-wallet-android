...
public class OTCSell extends BaseFragment {
    ...
    public static OTCSell newInstance(String title) {
        Bundle bundle = new Bundle();
        bundle.putString(BUNDLE_TITLE, title);
        OTCSell fragment = new OTCSell();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mainView == null) {
            mainView = inflater.inflate(R.layout.fragment_otc_sell, container, false);
            isInit = true;
            initView(mainView);
            setData();
        }
    ...
    private void initView(View mainView) {
        ...
        mTabLayout = mainView.findViewById(R.id.fragment_otc_sell_tablayout);

        mViewPager = mainView.findViewById(R.id.fragment_otc_sell_viewpager);
    ...
    private void setData() {
        if (isInit && !isLoadOver && isVisible) {
            ...
            mAdapter = new OTCContentAdapter(getSelfActivity().getSupportFragmentManager(), "IN");
            mViewPager.setAdapter(mAdapter);
        }
    }

    public void onPageSelected() {
        Log.e("OTCSell PageSelected");
