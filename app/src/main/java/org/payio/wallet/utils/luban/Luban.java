package org.payio.wallet.utils.luban;
...
public class Luban implements Handler.Callback {
    ...
    private Luban(Builder builder) {
        ...
        this.resultOnMainThread = builder.resultOnMainThread;
    ...
    public static class Builder {
        ...
        public Builder resultOnMainThread(boolean main) {
            this.resultOnMainThread = main;
            return this;
        }
