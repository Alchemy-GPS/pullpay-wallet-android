...
public class KProgressHUD {
   ...
   */
     ...
     * @return Current HUD
     */
    public KProgressHUD setLabelSize(float size_dp) {
        mProgressDialog.setTextSize(size_dp);
        return this;
    }
    ...
    private class ProgressDialog extends Dialog {
        ...
        public void setLabel(String label) {
            ...
            if (mLabelText != null) {
                if (label != null) {
                    ...
                    mLabelText.setTextSize(TypedValue.COMPLEX_UNIT_DIP, mTextSize);
        ...
        public void setTextSize(float size) {
            mTextSize = size;
            if (mLabelText != null) {
                mLabelText.setTextSize(TypedValue.COMPLEX_UNIT_DIP, size);
            }
        }
