...
public class BottomNavigationLayout extends LinearLayout {
    ...
    private List<BottomNavigationTab> mTabViews;
    ...
    public BottomNavigationTab getCurrentItemView() {
        isInit();
        return mTabViews.get(mCurrentItem);
    }

    public BottomNavigationTab getTabView(int tabIndex) {
        isInit();
    ...
    public void removeAllBadge() {
        isInit();
        for (BottomNavigationTab bottomNavigationTab : mTabViews) {
            bottomNavigationTab.removeShow();
        }
    }
    ...
    private void init() {
        ...
        for (int i = 0; i < mChildCounts; i++) {
            if (getChildAt(i) instanceof BottomNavigationTab) {
                BottomNavigationTab tabView = (BottomNavigationTab) getChildAt(i);
